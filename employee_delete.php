...
<html>
    ...
    if(isset($_POST["delete"])){
        if((is_numeric($_POST["eid"])) and (strlen($_POST["eid"])== 5) and ((checkEID($_POST["eid"])== true)) and ($_POST["eid"] != $_SESSION["eid"])){
                    $eid = (int)$_POST["eid"];
                    ...
                    if($userconn->query($sql)==true){
                        echo $eid." has been deleted";
                    }else{
                        echo "Employee has not been deleted. Please try again.";
                    }
                    $userconn->close();
                }else{
