...
<?php
        if ($_SESSION["logged_in"] == false ) {
            header("Location: nologin_restricted.php");
                ...
                header("Location: apparel_return_s.php");
        }
?>
<!DOCTYPE html>
<!--
...
<html>
    ...
    if(isset($_POST["return"])){
        if((is_numeric($_POST["sku"])) and (strlen($_POST["sku"])== 7) and ((checkSKU($_POST["sku"])== true))){
                    ...
                    if($_POST["write_off"]=="yes"){
                        $eid = $_SESSION["eid"];
                        $sql = "INSERT INTO write_off VALUES($sku, $eid, $eid, '$date[year]-$date[mon]-$date[mday]', 0)"; 
                    }
                    if($userconn->query($sql)==true){
                        echo $sku." has been returned";
                    }else{
