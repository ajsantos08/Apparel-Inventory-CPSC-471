...
<?php
        if ($_SESSION["logged_in"] == false ) {
            header("Location: nologin_restricted.php");
                ...
                header("Location: apparel_search_e.php");
        }
?>
<!DOCTYPE html>
<!--
                        ...
                        $userconn->close(); 
                            ...
                            if(($result = $userconn->query($sql))== true){
                                ...
                                $userconn->close();
                                    ...
                                    echo "<table class = 'table table-striped'><tr><th>SKU</th><th>Pice</th><th>Colour</th><th>Size</th><th>IN_STOCK</th></tr><tr><td>No Results</td><td></td><td></td><td></td><td></td></tr></table>";
                                }
                            }
                        }
                    }
